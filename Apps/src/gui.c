 ...
 * @retval 无
 */
void gui_flower(u16 x0, u16 y0, u16 x1, u16 y1, u8 size, u16 color1, u16 color2)
{
    ...
    for (i = 0; i <= (x1 - x0) * 2; t++)
    {
        ...
        if (t % 2 == 0)
        {
            gui_draw_arc(x0 + a, y0, x0 + size + a, y0 + size, x0 + (size / 2) + a, y0 + (size / 2), (size / 2), color1, 0);
        }
        else
        {
            gui_draw_arc(x0 + a, y0, x0 + size + a, y0 + size, x0 + (size / 2) + a, y0 + (size / 2), (size / 2), color2, 0);
        }
        i += size;
    }
    for (i = 0; i <= (x1 - x0) * 2; t++)
    {
        ...
        if (t % 2 == 0)
        {
            gui_draw_arc(x0 + a, y1 - size, x0 + size + a, y1, x0 + (size / 2) + a, y1 - (size / 2), (size / 2), color1, 0);
        }
        else
        {
            gui_draw_arc(x0 + a, y1 - size, x0 + size + a, y1, x0 + (size / 2) + a, y1 - (size / 2), (size / 2), color2, 0);
        }
        i += size;
    }
    for (i = 0; i <= (y1 - y0) * 2; t++)
    {
        ...
        if (t % 2 == 0)
        {
            gui_draw_arc(x1 - size, y0 + b, x1, y0 + size + b, x1 - (size / 2), y0 + (size / 2) + b, (size / 2), color1, 0);
        }
        else
        {
            gui_draw_arc(x1 - size, y0 + b, x1, y0 + size + b, x1 - (size / 2), y0 + (size / 2) + b, (size / 2), color2, 0);
        }
        i += size;
    }
    for (i = 0; i <= (y1 - y0) * 2; t++)
    {
        ...
        if (t % 2 == 0)
        {
            gui_draw_arc(x0, y0 + b, x0 + size, y0 + size + b, x0 + (size / 2), y0 + (size / 2) + b, (size / 2), color1, 0);
        }
        else
        {
            gui_draw_arc(x0, y0 + b, x0 + size, y0 + size + b, x0 + (size / 2), y0 + (size / 2) + b, (size / 2), color2, 0);
        }
        i += size;
    }
}
